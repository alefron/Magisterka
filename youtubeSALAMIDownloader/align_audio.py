...
downloaded_audio_folder = os.getcwd() + "/youtube_audios_wav"
transformed_audio_folder = os.getcwd() + "/salami_youtube_audios"
...
def reshape_audio(salami_id, match_data):
	...
	input_filename = downloaded_audio_folder + "/" + str(row["youtube_id"]) + ".wav"
	if not os.path.exists(input_filename):
		print("no file {0}".format(input_filename))
		return
